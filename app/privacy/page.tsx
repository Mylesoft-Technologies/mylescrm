      ...
      <main className="px-5 py-16 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-6 rounded-lg border border-border bg-card p-8 text-sm leading-7 text-muted-foreground shadow-sm">
            ...
            <PolicySection title="MylesCorp product context" text="MylesCRM follows the broader MylesCorp service principle: use technology to improve operational efficiency while respecting the organizations and communities served by the product." />
