      ...
      <main className="px-5 py-16 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <SectionHeader
            ...
            text="These terms summarize the expected professional use of MylesCRM and the responsibilities of customers using the platform."
          />
          <div className="space-y-6 rounded-lg border border-slate-200 bg-white p-8 text-sm leading-7 text-slate-600 shadow-sm">
            ...
            <TermsSection title="Payments and subscriptions" text="Paid plans may be billed according to the selected subscription terms. Payment providers may apply their own processing rules, verification steps, and transaction requirements." />
