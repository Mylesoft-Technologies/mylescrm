...
const features = [
    {
        ...
        description:
            "See the full history of every relationship: contacts, conversations, deals, invoices, and next actions.",
    },
    {
        title: "Pipeline clarity",
        description:
            "Track opportunities from first contact to closed revenue with stage, value, owner, and probability visible.",
    },
    {
        title: "Clear next steps",
        description:
            "Use activity history and reminders to keep every sales promise accountable.",
    },
    {
        title: "Built for serious teams",
        description:
            "Designed for growing teams that need CRM discipline without enterprise software drag.",
    },
];
        ...
        >
            <div className="mb-12 text-center lg:mb-16 max-lg:hidden">
                <h2 className="text-3xl font-medium tracking-tight text-foreground sm:text-4xl">
                    MylesCRM is designed for revenue teams
                </h2>
                <p className="mt-4 text-sm text-muted-foreground sm:text-lg">
                    Everything needed to manage relationships, deals, invoices, and follow-up in one focused workflow.
                </p>
            </div>
