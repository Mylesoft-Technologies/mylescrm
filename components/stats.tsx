...
const Stats = () => {
    const stats = [
        ...
        {
            name: "Connected customer record",
            value: 1,
            suffix: "",
        },
    ];
        ...
        >
            <div className="mb-16 flex flex-col items-center gap-3 px-4 text-center">
                <h2 className="text-3xl font-medium tracking-tight text-foreground sm:text-4xl">
                    Revenue relationships, organized
                </h2>
                <p className="max-w-md text-sm text-muted-foreground sm:text-base">
                    MylesCRM brings lead capture, pipeline movement, invoicing, and customer memory into one operating rhythm.
                </p>
            </div>
